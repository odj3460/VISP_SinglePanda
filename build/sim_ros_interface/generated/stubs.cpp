...
bool registerScriptStuff()
{
    try
    {
        ...
        try
        {
            ...
            sim::registerScriptCallbackFunction("simROS.getTime@ROS", "number time=simROS.getTime(int flag=0)\n\nReturn the current ROS time (i.e. the time returned by ros::Time::now()).", getTime_callback);
            ...
            sim::registerScriptCallbackFunction("simROS.getParamDouble@ROS", "bool exists,number value=simROS.getParamDouble(string name,number defaultValue=0.0)\n\nRetrieve a double parameter from the ROS Parameter Server.", getParamDouble_callback);
            ...
            sim::registerScriptCallbackFunction("simROS.setParamDouble@ROS", "simROS.setParamDouble(string name,number value)\n\nSet a double parameter in the ROS Parameter Server.", setParamDouble_callback);
